...
const Home = () => {
  ...
  const mail_links=[
    {adress:"pierre.lepagnol[at]lisn.upsaclay.fr",image:"logoLISN.svg",style:"mr-2",width:60,height:60},
    {adress:"pierre.lepagnol[at]sciam.fr",image:"logoSciam.png",style:"mr-2 invert",width:45,height:45}
    ...
    <div className="flex flex-col md:flex-row">
      <div className="md:w-1/2 flex justify-center p-8">
        <ExportedImage
          width={500}
          height={500}
          src="PierreLepagnol.jpg" alt="Pierre LEPAGNOL" />
      </div>
